function add_to_cart(event) {
    var itemContainer = event.target.closest('.card'); // Change this to '.benefit' to match your structure
    var itemName = itemContainer.querySelector('.sub').innerText; // Get the equpment name
